...
$query = "SELECT id_studente, Nome, Cognome, data_assenza FROM studente";
          ...
          <tbody class="table-body">
            ...
            if ($total != 0) {
              ...
              while ($result = mysqli_fetch_assoc($data)) {
                ...
                $giustifica_stringa = $giustifica ? 'Giustificato' : 'Non Giustificato';
                ...
                <tr>
                  ...
                  <td class='x-col'><a href='../azioni/giustifica.php?id=$result[id_studente]' >" . $giustifica_stringa . " </a></td>
                </tr>
              ";
                $k++;
